...
class DBConnection:
    ...
    def __init__(self,host: str, username:str, password: str, name: str, port:str) -> None:
        self.host = host
        self.user = username
    ...
    def get_instance(credantials: Dict[str,str]) -> object:
        if not DBConnection.__instance:
            DBConnection(credantials['DB_HOST'], credantials['DB_USER'], credantials['DB_PASS'],credantials['DB_NAME'],credantials['DB_PORT'])
